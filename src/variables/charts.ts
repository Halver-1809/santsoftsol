...
export const lineChartDataTotalSpent = [
	{
		name: 'Ausentismos por días',
		data: [ 59, 64, 48, 66, 49, 68 ] // Reemplazar con los datos correspondientes para cada mes
	},
	{
		name: 'Ausentismos por horas',
		data: [ 11, 40, 24, 46, 20, 46 ] // Reemplazar con los datos correspondientes para cada mes
	}
];
...
export const lineChartOptionsTotalSpent = {
	...
	xaxis: {
		type: 'numeric',
		categories: [ 'SEP', 'OCT', 'NOV', 'DEC', 'JAN', 'FEB' ], // Asegúrate de que estos son los meses correctos para los datos
		labels: {
			style: {
				colors: '#A3AED0',
				fontSize: '12px',
...
export const barChartData = [
  {
    name: 'Áreas de Nómina',
    data: Object.values(nominasData)
  }
];
...
export const barChartOptions = {
	...
	tooltip: {
	  theme: 'dark',
	  y: {
		formatter: (value: any) => `${value} áreas` // Formato del valor
	  },
	  custom: function({ series, seriesIndex, dataPointIndex, w }: any) {
		// Obtenemos la categoría (clave) correspondiente a la barra seleccionada
		const category = w.config.xaxis.categories[dataPointIndex];
		const value = series[seriesIndex][dataPointIndex];
		return `<div style="padding: 10px; background-color: #333; color: white; border-radius: 5px;">
				  <strong>${category}</strong>: ${value} áreas
				</div>`;
	  }
	},
	dataLabels: {
	...
	plotOptions: {
	  bar: {
		horizontal: false,
		columnWidth: '55%' // Grosor de las barras
	  }
	},
	xaxis: {
	  categories: Object.keys(nominasData),
	  labels: {
		style: {
		  colors: '#A3AED0',
		  fontSize: '12px',
...
export const zData = {
  'Esquemas  Z Nómina': 205,
  'Esquemas  Z Tiempos': 16,
  'Regla Z Nómina': 506,
  'Regla Z Tiempos': 214,
  'Funciones Z Nómina': 15,
  'Funciones Z Tiempos': 2,
  'Operaciones Z Nómina': 7,
  'Operaciones Z Tiempos': 2,
  'Características': 26,
  'Transacciones  Z para HCM': 50
};

// Configuración de los datos del gráfico de barras
export const barChartDataZ = [
  {
    data: Object.values(zData) // Los valores de cada categoría
  }
];
export const barChartOptionsZ = {
	chart: {
	  type: 'bar',
	  height: 350,
	  toolbar: {
	...
	plotOptions: {
	  bar: {
		horizontal: true, // Convierte el gráfico en horizontal
		borderRadius: 4,
		borderRadiusApplication: 'end', // Opcional: redondea el final de cada barra
	  }
	},
	dataLabels: {
	  enabled: false
	...
	xaxis: {
	  title: {
		text: 'Cantidad' // Título del eje X
	  },
	  categories: Object.keys(zData) // Las categorías son las claves de zData
	},
	tooltip: {
	  theme: 'dark',
	  y: {
		formatter: (value: any) => `${value} unidades` // Personaliza el valor mostrado en el tooltip
	  },
	  custom: function({ series, seriesIndex, dataPointIndex, w } : any) {
		...
		const value = series[seriesIndex][dataPointIndex];
		return `<div style="padding: 10px; background-color: #333; color: white; border-radius: 5px;">
				  <strong>${category}</strong>: ${value} unidades
				</div>`;
	  }
	},
	colors: ['#4318FF']
...
export const pieChartOptionsGroup = {
	labels: [
	  'Activo',
	  'Jubilado / Pensionado',
	  'Aprendiz',
	...
	colors: ['#FF823F', '#B4AAF9', '#B3F200', '#2501BA', '#33FF57'],
	chart: {
	  width: '50px'
	},
	states: {
  ...
  export const pieChartDataGroup = [19, 4, 8, 2, 1];
  
  export const pieChartOptionsDivision = {
    labels: [
    ...
    colors: ['#FF823F', '#B4AAF9', '#B3F200', '#2501BA', '#33FF57', '#FF4560', '#775DD0', '#00E396', '#008FFB'],
    chart: {
        width: '50px'
    },
    states: {
...
// Aquí se actualizan los datos, asumiendo que la cantidad es el número de subdivisiones por división
export const pieChartDataDivision = [
    7,  // CO01 - Smurfit Kappa Cartón Colombia (7 subdivisiones)
    1,  // CO04 - Reforestadora Andina (1 subdivisión)
    6,  // CO05 - Papelsa (6 subdivisiones)
    1,  // CO06 - Transbonsal (1 subdivisión)
    1,  // CO07 - Packing (1 subdivisión)
    5,  // CO08 - Colrecicladora (5 subdivisiones)
    5,  // CO10 - Colombates (5 subdivisiones)
    1,  // CO16 - Corrumed (1 subdivisión)
    5   // CO20 - Fundación SKC (5 subdivisiones)
];
