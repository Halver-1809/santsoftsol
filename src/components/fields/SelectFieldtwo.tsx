...
export default function Default(props: {
  ...
  [x: string]: any;
	...
	const { id, label, extra, isRequired, options, mb,onChange,value,isDisabled,handleSeletAttr,onSelectRefChange } = props;
// useEffect(()=>{
...
// console.log('value111',value);
    ...
    const handleSelectChange = (selectedOption: OptionType | null ) => {
      console.log('Select Ref:',selectRef.current.select, input);
        if(selectedOption) {        
