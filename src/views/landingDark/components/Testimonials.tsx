  ...
  return (
    <section id="Testimonials" className="py-20 md:py-24 flex justify-center items-center">
      <div className="container text-center">
        ...
        <p className="text-lg md:text-xl text-white/70 tracking-tight mt-5 max-w-sm mx-auto">
          Our tailored development solutions and Salesforce consulting services
          empower businesses to achieve their unique goals, transforming challenges into innovative successes.
        </p>
        <div className="flex overflow-hidden mt-10 [mask-image:linear-gradient(to_right,transparent,black_20%,black_80%,transparent)] justify-center">
          <motion.div
            initial={{
              translateX: "-50%",
            }}
